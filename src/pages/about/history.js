    ...
    return (
      <div>
        ...
        <div className='text-area'>
          ...
          <TextAreaText>
            Услугами компании «Инфорком» пользуются компании, работающие в сфере коммерческого автотранспорта, 
            – это Российские, международные и средние автоперевозчики, а также ИП и такси. Большое внимание 
            наша компания уделяет работе с бюджетными организациями: спецсвязь, коммунальные службы, перевозчики 
            вооружений, медицинские, правоохранительные и иные государственные учреждения.
          </TextAreaText>

          <TextAreaSpecial>
            30 лет мы заправляем топливом автоперевозчиков. Мы запустили новый личный кабинет, приготовили много 
            новых коммерческих и технологических решений для того, чтобы дать Вам возможность управлять затратами на топливо.  
            <br/>
            Мы всегда открыты для общения, для поиска компромиссов.
            Доверьте заправку профессионалам. Для нас это не только бизнес, для нас это – жизнь.
          </TextAreaSpecial>

          <TextAreaText>
            По нашим топливным картам уже заправляются более 10 тысяч автоперевозчиков
            и организаций государственного и муниципального сектора.
            <br/><br/>
            10 000 АЗС на территории России и стран СНГ работают по
            технологии нашей компании и принимают к оплате топливные карты и топливные талоны «Инфорком».
            <br/><br/>
            Нашими партнёрами являются топливные компании: «Газпромнефть»,
